...
# Output data path
outputpath='/scratch/v45/aek156/access-om2/archive/01deg_jra55v140_iaf_cycle3/output{0:03}/'.format(outputfilenumber)

# Import SSH values to python environment.
print(outputpath+'ocean/ocean-2d-sea_level-1-daily-mean-ym_*.nc')
...
#eddytd=analyseddyzt(eta,lon,lat,0,shape(eta)[0],1,levels,areamap=areamap,mask='',maskopt='',timeanalysis='none'\
...
eddytdn=analyseddyzt(-eta,lon,lat,0,shape(eta)[0],1,levels,areamap=areamap,mask='',maskopt='',timeanalysis='none'\
                     ,preferences=preferences,filters=filters,destdir='',physics='',diagnostics=False,pprint=False)
