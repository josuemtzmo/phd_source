...
# Output data path
analysedatap=np.load(outfolder+'npy/'+outputfilenumber+'_pos.npy')
dictanalysep=analysedatap.item()
reconstruct_p=reconstruct_syntetic(etashape,lon,lat,dictanalysep)

filename=outfolder+'post-processing/reconstructed_field_'+outputfilenumber+'_cyc.nc'
...
analysedatan=np.load(outfolder+'npy/'+outputfilenumber+'_neg.npy')
dictanalysen=analysedatan.item()
reconstruct_n=reconstruct_syntetic(etashape,lon,lat,dictanalysen)

filename=outfolder+'post-processing/reconstructed_field_'+outputfilenumber+'_acyc.nc'
...
plt.savefig(outfolder+'post-processing/reconstructed_field_'+outputfilenumber+'.png')

filename=outfolder+'post-processing/reconstructed_field_'+outputfilenumber+'.nc'
