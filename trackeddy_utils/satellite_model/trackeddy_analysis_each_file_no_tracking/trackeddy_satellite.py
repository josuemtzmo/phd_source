...
outfile='/g/data/v45/jm5970/trackeddy_output/AVISO+/test/'
...
save(outfile+"aviso_"+year+'-'+str(monthsin)+'-'+str(monthsend)+'_pos_no_tracking.npy',eddytd)
...
save(outfile+"aviso_"+year+'-'+str(monthsin)+'-'+str(monthsend)+'_neg_no_tracking.npy',eddytdn)
