    ...
    do
      ...
      do
        ...
        then
          ...
          echo "${python_path} ${cdir}reconstruct_$dataorigin.py $i $year $file_divisions $j $file_number" > $cdir$rundir/config.$(printf %05d ${counter%})
          ...
          echo "${python_path} ${cdir}reconstruct_$dataorigin.py $i $year $file_divisions $j $file_number" > $cdir$rundir/config.$(printf %05d ${core_count%})
